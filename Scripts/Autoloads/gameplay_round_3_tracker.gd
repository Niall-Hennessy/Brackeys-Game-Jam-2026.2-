...
func get_round_2_data():
	has_medical_card = GameplayRound2Tracker.has_medical_card
	found_means_item = GameplayRound2Tracker.found_means_item
	
	medical_card_ref = GameplayRound2Tracker.medical_card_ref
	means_item_ref = GameplayRound2Tracker.means_item_ref
